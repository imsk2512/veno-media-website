...
export function LinkedinIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" {...props}>
      ...
      <path d="M11 17v-4a2.5 2.5 0 0 1 5 0v4" strokeLinecap="round" strokeLinejoin="round" />
      <line x1="11" y1="17" x2="11" y2="10" strokeLinecap="round" />
    </svg>
  )
}
...
export function WhatsappIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" {...props}>
      <path d="M4 20l1.3-4A7.5 7.5 0 1 1 8 18.7L4 20z" strokeLinecap="round" strokeLinejoin="round" />
      <path
